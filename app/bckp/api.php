...
use App\Http\Controllers\Api\FobiMediaController;
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('/observations/crop-image', [FobiGeneralObservationController::class, 'cropImage']);
...
// Taxa Naming Flags API Routes
Route::prefix('taxa-flags')->group(function () {
    Route::post('/', [\App\Http\Controllers\Api\TaxaNamingFlagController::class, 'store']);
    Route::get('/types', [\App\Http\Controllers\Api\TaxaNamingFlagController::class, 'getFlagTypes']);
    Route::get('/stats', [\App\Http\Controllers\Api\TaxaNamingFlagController::class, 'getStats']);
    Route::get('/taxa/{taxaId}', [\App\Http\Controllers\Api\TaxaNamingFlagController::class, 'getByTaxa']);
});
...
use App\Http\Controllers\Api\TaxaDetailController;
Route::prefix('taxa')->group(function () {
    // Get detail for any taxonomic rank
...
// Tambahkan rute untuk persetujuan implisit
Route::middleware('auth:api')->group(function () {
    // Rute untuk memproses persetujuan implisit
...
// Media ratings and comments routes
Route::middleware('auth:api')->group(function () {
    Route::get('/media/{mediaId}/comments', [ChecklistDetailController::class, 'getMediaComments']);
    Route::post('/media/{mediaId}/comments', [ChecklistDetailController::class, 'addMediaComment']);
    Route::get('/media/{mediaId}/rating', [ChecklistDetailController::class, 'getMediaRating']);
    Route::post('/media/{mediaId}/rating', [ChecklistDetailController::class, 'rateMedia']);
});

// Burungnesia media ratings and comments routes
Route::get('/burungnesia/media/{mediaId}/comments', [BurungnesiaChecklistController::class, 'getMediaComments']);
Route::post('/burungnesia/media/{mediaId}/comments', [BurungnesiaChecklistController::class, 'addMediaComment']);
Route::get('/burungnesia/media/{mediaId}/rating', [BurungnesiaChecklistController::class, 'getMediaRating']);
Route::post('/burungnesia/media/{mediaId}/rating', [BurungnesiaChecklistController::class, 'rateMedia']);

// Kupunesia media ratings and comments routes
Route::get('/kupunesia/media/{mediaId}/comments', [KupunesiaChecklistController::class, 'getMediaComments']);
Route::post('/kupunesia/media/{mediaId}/comments', [KupunesiaChecklistController::class, 'addMediaComment']);
Route::get('/kupunesia/media/{mediaId}/rating', [KupunesiaChecklistController::class, 'getMediaRating']);
Route::post('/kupunesia/media/{mediaId}/rating', [KupunesiaChecklistController::class, 'rateMedia']);

// Observations related routes
Route::prefix('observations')->group(function () {
...
// Tambahkan route untuk endpoint IUCN status
Route::get('/observations/iucn-status', [ChecklistObservationController::class, 'getIUCNStatus']);

Route::middleware('auth:api')->group(function () {
    // Rute untuk user observations
    Route::get('/user-observations', [FobiUserObservationController::class, 'getUserObservations']);
    Route::get('/user-observations/{id}', [FobiUserObservationController::class, 'getObservationDetail']);
    Route::put('/user-observations/{id}', [FobiUserObservationController::class, 'updateObservation']);
    Route::delete('/user-observations/{id}', [FobiUserObservationController::class, 'deleteObservation']);
    
    // Rute khusus untuk mengelola media observasi
    Route::post('/user-observations/{id}/media', [FobiMediaController::class, 'addMedia']);
    Route::delete('/user-observations/{id}/media', [FobiMediaController::class, 'deleteMedia']);
});
